...
// Décommente cette ligne une fois tes identifiants renseignés :
...
form.addEventListener('submit', function (e) {
  ...
  // Une fois EmailJS configuré (voir bloc ci-dessus), remplace ce bloc par :
  //
  ...
  // Message temporaire tant qu'EmailJS n'est pas branché :
